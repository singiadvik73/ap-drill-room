...
const surveySvg = {
  ...
  c: `<rect x="10" y="10" width="200" height="140" class="d-fill"/><path d="M40 10 C 60 60, 30 100, 70 150" class="d-water" fill="none" stroke-width="5"/><path d="M10 70 L55 64 L100 88 L128 40 L128 10 M100 88 L118 150 M128 40 L210 58 M160 52 L150 110 L210 118 M150 110 L118 150" class="d-ln"/>` + [[140, 30], [175, 90], [85, 125]].map(([x, y]) => `<circle cx="${x}" cy="${y}" r="7" class="d-thin"/>`).join("")
};
